...
<div class="container">
    <h1>Web server correctly installed this means that wordpress is not installed.</h1>
    ...
    <div class="footer">
        <p>Powered by <a href="https://nexohost.es" target="_blank">NexoHost Corporation</a></p>
    </div>
</div>
